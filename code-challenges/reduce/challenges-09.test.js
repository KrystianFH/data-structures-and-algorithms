...
const mapCurrentEvents = () => {
  // Solution code here...
  return currentEvents.news.map(potato => new Event(potato));
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let numElements = arr.reduce((accumulator, value, idx) => {
...
const returnNames = (arr) => {
  // Solution code here...
 function takeNames (accumulator, current){
   accumulator.push(current.name);
   return accumulator;
 }

 return arr.reduce(takeNames, []);
};
